...
const Cart = () => {
  ...
  const [updateAddress, setUpdateAddress] = useState('Chhawala, pahadwa colony , new delhi 110071')
        ...
        <div className=" flex h-28 flex-1  items-center justify-between gap-20 rounded-3xl border px-5">
          <div className="flex items-center justify-between">
            ...
            <input
              ...
              className="w-[150px] border-b-2 px-5 py-2 text-lg font-semibold outline-none"
            />
          </div>
          ...
          <div className="flex w-full  items-center gap-2">
            ...
            <input
              ...
              placeholder="Address"
              disabled={!updateDetails}
              className="flex-1  border-b-2 px-5 py-2 text-lg font-semibold outline-none"
              value={updateAddress}
